...
function buildSakuraOptions(
  profile: SakuraResolvedProfile,
  visuals: SakuraVisuals
): SakuraParticlesOptions {
  ...
  return {
    ...
    particles: {
      ...
      size: {
        ...
        value: toRange(profile.scale, PETAL_RADIUS),
      },
      tilt: {
        animation: {
          decay: 0,
